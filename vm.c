...
//< Types of Values is-falsey
//> Strings concatenate
// Chapter 19 - Challenge Question 1
// Modified concatenate() to create string object and then write concatenated string
...
//> Closures interpret-closure
      case OP_CLOSURE: {
        ...
        // Updates for challenge question
        ObjFunction* function = AS_FUNCTION(READ_CONSTANT())
        ...
        // Update in run to avoid any closures
        ObjClosure* closure = newClosure(function);
        push(OBJ_VAL(closure));
